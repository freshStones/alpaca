...
#include "../../Interface_BT/policyOp.h"
...
struct qt_meta_stringdata_policyOp_t {
    QByteArrayData data[5];
    char stringdata[53];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_policyOp_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_policyOp_t qt_meta_stringdata_policyOp = {
    {
...
QT_MOC_LITERAL(4, 32, 19)
    ...
    "policyOp\0setProgressBarValue\0\0x\0"
    "setProgressBarRange\0"
};
...
void policyOp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (policyOp::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&policyOp::setProgressBarValue)) {
                *result = 0;
            }
        }
        {
            typedef void (policyOp::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&policyOp::setProgressBarRange)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject policyOp::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_policyOp.data,
      qt_meta_data_policyOp,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_policyOp.stringdata))
